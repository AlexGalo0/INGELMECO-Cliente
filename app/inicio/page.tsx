    ...
    <section>
      <div className=" p-5 pt-8 lg:flex justify-evenly animate-fade-down animate-once animate-ease-linear">
        ...
        <div className="w-full lg:w-1/2 mr-2 lg:mx-auto">
          <h1 className="pt-4">INGELMECO</h1>
          <div className="pt-6">
            <p>
          ...
          <div className="pt-12">
            <Link href="/">
              <button
                type="button"
                className="text-white bg-[#048C88] hover:bg-[#057E79] focus:ring-4 focus:outline-none focus:ring-[#057E79] font-medium rounded-lg text-base px-5 py-2.5 text-center inline-flex items-center dark:bg-[#057E79] dark:hover:bg-[#046C68] dark:focus:ring-[#046C68]"
              >
                Nuestro Catálogo
                <svg
      ...
      <div className="bg-[#202020] pt-3 text-center pb-7">
        <div className="mx-auto max-w-full lg:max-w-[680px]">
          <h2 className=" text-2xl font-bold text-[#eee1e1] ">
            Nuestra especialidad , Productos Siemens
          </h2>
          <p className="text-dark p-4 text-lg text-[#eee1e1]">
            Como distribuidores oficiales de SIEMENS , puedes encontrar mucha
